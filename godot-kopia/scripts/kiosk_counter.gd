...
func _draw() -> void:
	if not hovered and not interaction_focused:
		return
	draw_rect(Rect2(-58, -51, 116, 55), Color("#efb64788"), false, 4)
	draw_colored_polygon(PackedVector2Array([Vector2(-12, 12), Vector2(12, 12), Vector2(0, -2)]), Color("#efb647"))
