...
func _run() -> void:
	...
	_expect(rules.player_max_health == 110 and rules.player_health == 110, "Kondycja zwiększa maksymalne życie")
	...
	_expect(game.player_xp == xp_before_fight + game.active_combat_xp_reward, "Wygrana walka daje doświadczenie z konfiguracji przeciwnika")
